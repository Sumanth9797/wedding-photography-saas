        ...
        <div className="p-6 max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-card p-6 mb-6">
            <div className="flex items-center justify-between relative">
              ...
              <div
                className="absolute top-5 left-0 h-0.5 bg-gradient-to-r from-primary-500 to-secondary-600 z-0 transition-all duration-500"
                ...
                return (
                  <div key={s.id} className="relative z-10 flex flex-col items-center gap-2">
                    <div className={clsx(
                      ...
                      isCompleted ? 'bg-primary-100 border-primary-400' :
                      isCurrent ? 'bg-primary-500 border-primary-600' :
                      'bg-white border-gray-200'
                    )}>
                      {isCompleted
                        ? <FiCheck className="w-5 h-5 text-primary-600" />
                        : <Icon className={clsx('w-4 h-4', isCurrent ? 'text-white' : 'text-gray-300')} />
                      }
                    </div>
                    <span className={clsx(
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      form.isPrivate ? 'bg-primary-500' : 'bg-gray-300'
                    )}
                  >
                    <div className={clsx(
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-5 border border-primary-100">
                  <h3 className="font-bold text-gray-900 text-lg mb-4 flex items-center gap-2">
                    <FiCamera className="text-primary-500" /> {form.title}
                  </h3>
          ...
          <div className="flex items-center justify-between">
            ...
            {step < 4 ? (
              <button
                type="button"
                onClick={handleNext}
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-primary-500 to-secondary-600 text-white font-semibold text-sm hover:from-primary-600 hover:to-secondary-700 transition-all hover:scale-[1.01]"
              >
