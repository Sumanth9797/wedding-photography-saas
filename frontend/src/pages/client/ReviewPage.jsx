      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
              ...
              return (
                <div key={photo.id || i} className={clsx('bg-white rounded-2xl overflow-hidden shadow-card transition-all duration-300', r.approved === true && 'ring-2 ring-emerald-400', r.approved === false && 'ring-2 ring-red-400')}>
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute top-2 left-2"><span className="bg-emerald-600/90 text-white text-xs px-2 py-0.5 rounded-full font-medium">Edited</span></div>
                    {r.approved !== null && (
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button onClick={() => setReview(photo.id, 'approved', true)}
                        className={clsx('flex items-center justify-center gap-1.5 py-2 rounded-xl text-sm font-medium transition-all', r.approved === true ? 'bg-emerald-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-emerald-50 hover:text-emerald-700')}>
        ...
        {!loading && photos.length > 0 && (
          <div className="mt-8 flex justify-center">
            <button onClick={handleSubmit} disabled={submitting || reviewedCount === 0}
              className="flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-10 py-4 rounded-xl font-bold text-base hover:from-emerald-600 hover:to-teal-600 transition-all hover:scale-[1.02] disabled:opacity-50 shadow-lg">
