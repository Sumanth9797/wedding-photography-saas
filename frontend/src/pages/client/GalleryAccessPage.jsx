...
export default function GalleryAccessPage() {
  ...
  return (
    ...
    >
      {/* Background blobs */}
      <div className="absolute top-20 left-20 w-80 h-80 bg-primary-600/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-secondary-600/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
      ...
      <div className={clsx('relative w-full max-w-sm', shake && 'animate-shake')}>
        <div className="glass rounded-3xl p-8 border border-white/20 shadow-2xl text-center">
          {/* Icon */}
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center mx-auto mb-6 shadow-glow">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-3.5 rounded-xl font-semibold text-base hover:from-primary-700 hover:to-secondary-700 transition-all hover:scale-[1.01] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-md"
            >
              {loading ? (
